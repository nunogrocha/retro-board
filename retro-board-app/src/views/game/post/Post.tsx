    ...
    <>
      ...
      >
        {(provided: DraggableProvided) => (
          <PostCard variant="outlined" ref={provided.innerRef} {...provided.dragHandleProps} {...provided.draggableProps}>
            <CardContent>
...
const ActionBarItemsAuthor = styled(ActionBarItems)`
  margin-right: 10px;
`;
